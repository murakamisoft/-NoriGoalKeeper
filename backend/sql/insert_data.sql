...
(1, 'マラソンコスプレ', 'マラソンにコスプレで参加する', '2025-04-15', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, '一週間サバイバル', '自然の中で一週間サバイバル生活を体験する', '2025-08-30', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, '自作楽器', '自分で楽器を作り、演奏する', '2025-05-15', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, 'キャンプで一晩', '友達とキャンプをして一晩過ごす', '2025-06-10', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, '週一アートデー', '毎週アートを楽しむ日を作り、何かを創作する', '2025-12-31', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1, '無限ループ読書', '1ヶ月間、毎日同じ本を読み続ける', '2025-09-01', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
